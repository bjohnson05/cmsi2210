...
int main( int argc, char * argv[] ) {
   ...
   *    loop through the letters to find each character in the
  ...
  /*
   *  As an added bonus, this program also does the same thing
   *    as the previous loop, but prints out the MORSE CODE
   *    version of each letter instead of the NATO version.
   */
   for( i = 1; i < argc; i++ ) {
      for( j = 0; argv[i][j] != '\0'; j++ ) {
         for( k = 0; ALPHABET[k] != '\0'; k++ ) {
